...
impl<'a> Mipmaps<'a> {
    ...
    pub fn build(&mut self, required_levels: usize) -> usize {
        ...
        while src_level < required_levels {
            ...
            let mut downsample: fn(&[PremultipliedColorU8], usize, usize, &mut [PremultipliedColorU8], usize, usize) = downsample_2_2;
...
/// be generated
pub fn compute_required_levels(base_pixmap: PixmapRef, scale_x: f32, scale_y: f32) -> (usize, f32, f32) {
    ...
    while scale_x*prescale_x < 0.5 && level_width > 1 &&
          scale_y*prescale_y < 0.5 && level_height > 1 {
        required_levels += 1;
        level_width = (level_width as f32 / 2.0).floor() as u32;
        level_height = (level_height as f32 / 2.0).floor() as u32;
...
fn downsample_2_2(src_pixels: &[PremultipliedColorU8], src_y: usize, src_width: usize, dst_pixels: &mut [PremultipliedColorU8], dst_y: usize, dst_width: usize) {
    ...
    for dst_x in 0..dst_width {
        ...
        dst_pixels[dst_y*dst_width+dst_x] = PremultipliedColorU8::from_rgba_unchecked(r, g, b, a);

        src_x += 2;
    }
}

fn downsample_2_3(src_pixels: &[PremultipliedColorU8], src_y: usize, src_width: usize, dst_pixels: &mut [PremultipliedColorU8], dst_y: usize, dst_width: usize) {
    // Given pixels:
    // a0 b0 c0 d0 ...
    // a1 b1 c1 d1 ...
    // a2 b2 c2 d2 ...
...
fn downsample_3_2(src_pixels: &[PremultipliedColorU8], src_y: usize, src_width: usize, dst_pixels: &mut [PremultipliedColorU8], dst_y: usize, dst_width: usize) {
    // Given pixels:
    // a0 b0 c0 d0 e0 ...
    // a1 b1 c1 d1 e1 ...
    // We want:
...
fn downsample_3_3(src_pixels: &[PremultipliedColorU8], src_y: usize, src_width: usize, dst_pixels: &mut [PremultipliedColorU8], dst_y: usize, dst_width: usize) {
    // Given pixels:
    // a0 b0 c0 d0 e0 ...
    // a1 b1 c1 d1 e1 ...
    // a2 b2 c2 d2 e2 ...
    ...
    for dst_x in 0..dst_width {
        ...
        let r = (sum_channel!(red,   p1, p2,p2, p3, p4,p4, p5,p5,p5,p5, p6,p6, p7, p8,p8, p9) >> 4) as u8;
        let g = (sum_channel!(green, p1, p2,p2, p3, p4,p4, p5,p5,p5,p5, p6,p6, p7, p8,p8, p9) >> 4) as u8;
        let b = (sum_channel!(blue,  p1, p2,p2, p3, p4,p4, p5,p5,p5,p5, p6,p6, p7, p8,p8, p9) >> 4) as u8;
        let a = (sum_channel!(alpha, p1, p2,p2, p3, p4,p4, p5,p5,p5,p5, p6,p6, p7, p8,p8, p9) >> 4) as u8;
        dst_pixels[dst_y*dst_width+dst_x] = PremultipliedColorU8::from_rgba_unchecked(r, g, b, a);
